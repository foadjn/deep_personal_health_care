package sharif.deeppersonalheartcare.newModel;
...
public class OurModel {
    ...
    public OurModel(Context context) {
    ...
    public String modelCore() {
        ...
        ArraysFactory arrayFactory = new ArraysFactory(context);
